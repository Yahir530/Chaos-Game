...
int main() {
	...
	RenderWindow window(vm, "ChaosGame", Style::Fullscreen);
	RenderWindow window(vm, "THE CHAOS", Style::Fullscreen);
	...
	while (window.isOpen()) {
		...
		text.setString("Press 3 points for the veritices and click again to start!;
